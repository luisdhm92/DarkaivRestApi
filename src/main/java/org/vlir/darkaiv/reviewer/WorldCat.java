...
//    private static WorldCat instance;
//    private String host = "http://xisbn.worldcat.org/webservices/xid/isbn/";
//    private String config = "?method=getMetadata&format=json&fl=*";
    private String host;
...
//    public static WorldCat instance() {
//        if (instance == null) {
//            instance = new WorldCat();
//        }
//        return instance;
//    }
...
//        URL url = new URL(resources.getString("worldcat.server.url") + isbn + resources.getString("worldcat.server.url.config"));
        URL url = new URL(host + isbn + config);
